...
import { ensureUser, logUsage, logPayment, getStats, getUsageLogs, getPaymentLogs, } from "./db.js";
...
function renderShakePage(error, payload, lines) {
    const tz = payload?.timezone || "Asia/Shanghai";
    const defaultDatetime = payload?.datetime ||
...
function renderResultPage(payload, output, interpretation) {
    const html = `<!doctype html>
<html lang="zh">
<head>
  <meta charset="UTF-8" />
